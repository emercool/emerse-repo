...
public class WordCountRanking {

    private static final String OUTPUT_PATH = "/data/outputfinal1";
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(WordCountRanking.class);
        job.setJar("wordcountranking.jar");
        ...
        job2.setJarByClass(WordCountRanking.class);
        job2.setJar("wordcountranking.jar");
